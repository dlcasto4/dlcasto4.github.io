function updateNavAndFooter() {
    ...
    navm.innerHTML = `
        ...
        <div class="right">
            <button class="navbtn" onclick="window.location.href='/axis/';"><i class="wicon wicon-axis"></i><br><span class="navtext">Axis</span></br></button>
           <button class="navbtn" onclick="window.location.href='/games/';"><i class="wicon wicon-gamepad-handles"></i><br><span class="navtext">Games</span></br></button>
           <button class="navbtn" onclick="window.location.href='/music/';"><span class="navtext">music</span></button>
